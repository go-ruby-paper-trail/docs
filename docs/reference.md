...
The public API lives at the module root (`github.com/go-ruby-paper-trail/paper-trail`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `paper-trail`, while the surface follows
...
```go
import "github.com/go-ruby-paper-trail/paper-trail"
```
...
- **[pkg.go.dev/github.com/go-ruby-paper-trail/paper-trail](https://pkg.go.dev/github.com/go-ruby-paper-trail/paper-trail)**

The module's [README](https://github.com/go-ruby-paper-trail/paper-trail#readme) carries worked
